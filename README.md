...
Every full session is also logged to Logs\\CleanROMs\_<date>.log.



## Documentation

Full user manuals, in both English (CleanROMs\_Manual\_EN.pdf) and Spanish
(CleanROMs\_Manual\_ES.pdf), covering the scoring system, tie-break rules,
...
(Logs\\CleanROMs\_<date>.log) and, if possible, a full file listing of the
