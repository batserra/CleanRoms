...
Cada sesión completa también se registra en Logs\\CleanROMs\_<fecha>.log.
...
(CleanROMs\_Manual\_EN.pdf) como en español (CleanROMs\_Manual\_ES.pdf),
...
archivo de log de esa ejecución (Logs\\CleanROMs\_<fecha>.log) y, si es
